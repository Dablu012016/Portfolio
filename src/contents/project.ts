...
export const projects: Project[] = [
  ...
  {
    title: 'WeAnalyze Web-App',
    description: 'Transform Complex Data into Actionable Insights with Real-Time Analytics.',
    technologies: ['React.js', "Redux-toolkit", 'JavaScript', 'TailwindCSS','MongoDb','Express.js' ,'HTML'],
    githubLink: 'https://github.com/Dablu012016/web_app',
    demoLink: 'https://web-auv5khtnv-dablu-kumars-projects-a9f604e2.vercel.app/',
    image: '/projects/WeAnalyze.jpeg',
  },
  {
    title: 'Financial Dashboard',
    description: 'Track Income, Expenses, and Financial Growth with Real-Time Insights.',
    technologies: ['React.js', 'JavaScript', 'TailwindCSS', 'HTML'],
    githubLink: 'https://github.com/Dablu012016/Finance_Dashboard',
    demoLink: 'https://reliable-finance-dashboard.netlify.app/',
